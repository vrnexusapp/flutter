...
class _ProductsPageState extends ConsumerState<ProductsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedGlassBackground(
      child: Scaffold(
        backgroundColor:
            Colors.transparent, // Make scaffold transparent to see background
        extendBodyBehindAppBar:
            true, // Allow content to scroll under frosted appbar
        appBar: PreferredSize(
          preferredSize: const Size.fromHeight(
            110,
          ), // Adjust height for app bar + search
          child: ClipRRect(
            // Clip the blur to the appbar bounds
              ...
              child: GridView.builder(
                ...
                padding: EdgeInsets.only(
                  ...
                  top:
                      ...
                      110 +
                      16, // Push list down below the floating app bar
